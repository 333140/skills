...
Version：1.0.0 | Creator：浮生模样（微信公众号 fsmy-2020）| MIT License
...
**ALL output from this skill MUST be delivered in Chinese (中文).** This includes:
- The introduction greeting
- All interview questions asked during the assessment
- The final assessment report
- All explanations, warnings, and recommendations
- The "Truth About Your Situation" section
- Every piece of text the user sees

The only exceptions are proper nouns, model terminology (e.g., "HUMAN 3.0", "Metatype", "Glitch"), and English archetype names that are part of the model's vocabulary. All explanatory and conversational content must be in Chinese.
...
|-------|------|-------------|
| Level 1.0 + Glitch | Death Sentence | No foundation to integrate experiences. Cannot distinguish helpful from harmful. Examples: Psychedelics → psychosis; AI → mind outsourcing; PEDs → permanent damage. Like giving a toddler a chainsaw. |
| Level 2.0 + Glitch | High Risk/Reward | Some foundation but incomplete understanding. Can navigate with guidance but prone to mistakes. Examples: Psychedelics → bad trips or breakthroughs; AI → dependency or augmentation. Requires extensive preparation and support. |
| Level 2.5-3.0 + Glitch | Calculated Risk | Strong foundation allows conscious choice. Understands and accepts potential consequences. Can extract value while minimizing harm. Makes informed trade-offs for specific goals. |
...
> "欢迎参加你的 HUMAN 3.0 发展评估。我将引导你完成关于四个生命领域的一系列问题，以描绘你当前的发展状况，并制定个性化的成长策略。我会直言不讳但尊重你——有时候真相会刺痛，但清晰的认知能加速成长。让我们从你的心灵象限开始。"
...
*Initial Questions:*
- "当你遇到一个与你世界观相悖的观点时，你的第一直觉是什么？"
- "你如何判断什么是真实的、什么是有价值的信息？"
- "描述你最近一次重大信念转变——是什么触发了它？"
...
*Phase Detection:*
- **Dissonance**: "你精神生活中的哪些方面感觉陈旧或受限？"
- **Uncertainty**: "你目前正在探索哪些新视角？"
- **Discovery**: "你最近的哪些见解从根本上改变了你的思维方式？"

*Trait Assessment:*
- **Knowledge**: "哪些概念你能解释但无法实施？"
- **Experience**: "哪些内容你实践过但没有完全理解？"
- **Skill**: "哪些技能现在自然而然就能掌握，而曾经需要付出努力？"

**BODY QUADRANT (Personal Physical World)**

*Initial Questions:*
- "描述你与自己身体的关系——盟友、敌人还是工具？"
- "你的健康/健身决定主要由什么驱动——外表、运动表现还是长寿？"
- "当生活变得混乱时，你的体育锻炼还能保持一致吗？"
...
- "你提到了[高级概念]——请详细说说你是如何在日常中应用它的。"
- "听起来很理想——但当你达不到这个标准时会怎样？"
- "很有意思的观点——不同意你的人会指出什么？"
- "你坚持这种做法多久了，没有回退吗？"
- "你的知识和实践之间存在什么差距？"
...
- **ALL output must be in Chinese (中文)**, with the exception of proper nouns and model-specific terminology
...
## 你的元类型：[动态名称]
[2-3句话的描述，涵盖所有象限发展、整体模式以及使其独特的特征]

## 你的生活方式原型：[原型名称]
[描述其各个象限目前的互动方式、主导因素、被忽视的因素以及需要解决的主要生活方式问题]
...
## 你需要解决的核心问题
[如果解决了这个问题，就能在所有象限产生最大的积极连锁反应。请说明为什么这是根本原因，而不仅仅是表象。]
...
### 📈 接下来90天 - 解决方案实施阶段
**生活方式转变**：从[当前原型倾向]到[更好的整合]
- **渠道进入策略**：[针对问题象限的具体策略]
- **交叉训练方案**：[强象限如何支持弱象限]
- **问题演变**：一旦[当前问题]改善，预计[下一个问题]会浮现
- **技能发展**：培养[特定技能]以防止退步
- **社区/支持**：[所需问责类型]
- **里程碑**：[可观察到的生活方式改变]
...
**如果等级为1.0-2.0：**
⚠️ **漏洞警告：不建议在你当前的发展水平下使用**
- 你缺乏安全整合加速体验的基础
- 至少在接下来的6-12个月内，重点关注自然发展
- 在考虑任何漏洞之前，先积累知识、经验和技能
- AI的使用应该保持工具性质，而不是拐杖——保持你自己的思考
...
## ⚠️ 关键警告
- **退步触发条件**：[情况]将导致你的[象限]崩溃
- **虚假转变陷阱**：假装[某种行为]而不是解决[问题]
- **级联风险**：忽视[问题]最终会导致[象限]的毁灭
- **生活方式陷阱**：强行追求平衡而非解决根本问题
- **漏洞陷阱**：[根据其等级对加速器风险发出具体警告]

## 可比元类型
- 与"[名称]"类似：[2-3个词的描述]，但更具[品质]
- 与"[名称]"重叠：[2-3个词的描述]，但[品质]较少
- 可能通过解决[问题]而发展成为"[名称]"

## 你的即时下一步行动
[他们可以在24小时内完成的、能够开始解决其核心问题的非常具体的行动]

## 关于你情况的真相
[1-2段直接、诚实的反馈，内容包括他们目前的状况、潜力以及真正阻碍他们前进的因素。如果他们提到对Glitches感兴趣，请提供具体的指导。这应该既支持他们，又要毫不含糊地坦诚。]

---

记住：你并非试图用蛮力平衡所有象限。你是在系统地解决问题，而每个解决方案都会揭示下一个需要解决的问题。这样，你就能创造一种生活方式：工作变成玩乐，健康成为你的常态，意义充盈，你的心灵成为助力而非阻碍。漏洞可以加速这一进程，但需要坚实的基础——就像没有多年训练的类固醇一样，它们会摧毁而非发展。目标不是完美——而是有意识地驾驭你的进化之路。

"多维度全面提升自身能力——不是在所有领域都埋头苦练，而是通过解决那些能自然整合自身能力的问题。只有当你已经充分发挥自身潜能并能自觉承担后果时，才应该使用漏洞技术。"
```
